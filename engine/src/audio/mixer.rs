...
struct PrecisionMixerQueuedTrack {
    start_at_sample_number: Option<u64>,
...
impl PrecisionMixerController {
    ...
    pub fn reset_sample_counter(&self, new: u64) {
    ...
    pub fn play_at_sample_number<T, S>(
        &self,
        start_at_sample_number: Option<u64>,
        source: T,
        volume: f32,
        ...
        MySample: FromSample<S>,
    {
        ...
        self.play_at_sample_number(
            Some(sample_offset + start_at_sample_number as u64),
            source,
            volume,
            pan,
        );
        ...
        MySample: FromSample<S>,
    {
        let start_at_sample_number = (tick as f64 * self.sample_rate as f64
            / tick_rate as f64) as i64
            + (self.sample_rate as i64 * offset_nanos as i64 / 1_000_000_000);
        self.play_at_sample_number(
            Some((sample_offset as i64 + start_at_sample_number) as u64),
            source,
            volume,
            pan,
        );
...
impl PrecisionMixer {
    ...
    fn process_pending(&mut self) {
        ...
        for track in pending.iter_mut() {
            ...
            for _ in 0..(missed_by * source.channels() as u64) {
...
pub fn init_mixer(
    ...
    let controller = PrecisionMixerController::new(channels, sample_rate);
